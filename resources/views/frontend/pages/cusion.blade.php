...
<div class="bg-primary py-12 px-6 text-center">
    <h1 class="text-4xl font-bold text-gray-800 mb-4">Ergo Cusion </h1>
    {{-- <p class="text-lg text-gray-600 mb-6">Find the perfect Insole for your feet</p> --}}
    {{-- <a 
      href="#" 
      class="inline-block px-6 py-3 text-white bg-blue-600 hover:bg-blue-700 rounded-md text-lg font-medium"
    >
      Know your insole
    </a> --}}
  </div>
  ...
  <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div class="bg-white shadow rounded-lg overflow-hidden">
              <div class="bg-yellow-100 text-center">
                  <img src="{{ asset('assets/image/p2.jpg') }}" alt="Work From Home Combo"
                      class="w-full h-56 object-fill rounded-md">
              </div>
              <div class="px-4">
          ...
          <div class="bg-white shadow rounded-lg overflow-hidden">
              <div class="bg-yellow-100 text-center">                
                  <img src="{{ asset('assets/image/p1') }}" alt="Ultimate Pro Seating Combo"
                      class="w-full h-56 object-fill rounded-md">
              </div>
              <div class="px-4">
                  <div class="bg-black rounded-[20px] border border-white p-1">
    ...
    {{-- post text --}}
    <div class="bg-yellow-400 py-12 sm:py-16   mb-6 text-center">
      <!-- Title -->
