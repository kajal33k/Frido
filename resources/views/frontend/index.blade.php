  ...
  <div class="swiper-wrapper">
    ...
    <div class="swiper-slide">
      <div class="bg-white border rounded-lg shadow-lg">
        <img src="{{asset('assets/image/Product1')}}" alt="Product 1" class="w-full h-48 object-cover rounded-t-lg">
        <div class="p-4">
          ...
          <div class="flex items-center justify-between mt-3">
            ...
            <button class="bg-amber-500 text-white py-2 px-4 rounded-lg hover:bg-amber-600 focus:outline-none">Add to Cart</button>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="swiper-slide">
      <div class="bg-white border rounded-lg shadow-lg">
        <img src="{{asset('assets/image/Product1')}}" alt="Product 2" class="w-full h-48 object-cover rounded-t-lg">
        <div class="p-4">
    ...
    <div class="swiper-slide">
      <div class="bg-white border rounded-lg shadow-lg">
        <img src="{{asset('assets/image/Product1')}}" alt="Product 3" class="w-full h-48 object-cover rounded-t-lg">
        <div class="p-4">
    ...
    <div class="swiper-slide">
      <div class="bg-white border rounded-lg shadow-lg">
        <img src="{{asset('assets/image/Product1')}}" alt="Product 4" class="w-full h-48 object-cover rounded-t-lg">
        <div class="p-4">
...
<div class="bg-[#FDF8CC] py-8 mt-8">
  ...
  <div class="grid grid-cols-1 lg:grid-cols-3 gap-2">
    <div class="flex justify-center">
      <img src="{{asset('assets/image/Awards-01.webp')}}" alt="Award 1" class="w-full h-auto max-w-xs rounded-lg shadow-lg">
    </div>
    <div class="flex justify-center">
      <img src="{{asset('assets/image/Awards-02.webp')}}" alt="Award 2" class="w-full h-auto max-w-xs rounded-lg shadow-lg">
    </div>
    <div class="flex justify-center">
      <img src="{{asset('assets/image/Awards-03.webp')}}" alt="Award 3" class="w-full h-auto max-w-xs rounded-lg shadow-lg">
    </div>
  </div>
</div>
...
<div 
  ...
  <div class="hs-carousel w-full overflow-hidden rounded-lg ">
    <!-- Carousel Body -->
    <div 
      class="hs-carousel-body flex flex-nowrap transition-transform duration-700 ease-in-out">
      <!-- Slide 1 -->
      <div class="hs-carousel-slide flex-shrink-0 w-full md:w-1/2 lg:w-1/4 px-2">
        <div class="bg-white rounded-lg shadow-lg overflow-hidden p-4">
          <img
            src="{{asset('assets/image/download.jpeg')}}" 
            alt="Frido and RCB Partnership"
          ...
          <div class="mt-2">
            ...
            <a href="#" class="text-blue-600 font-medium hover:underline mt-1 inline-block text-xs">Read More</a>
          </div>
        </div>
      </div>
       <!-- Slide 1 -->
      ...
      <div class="hs-carousel-slide flex-shrink-0 w-full md:w-1/2 lg:w-1/4 px-2">
        <div class="bg-white rounded-lg shadow-lg overflow-hidden p-4">
          <img
            src="{{asset('assets/image/download.jpeg')}}"
            alt="Frido Ergonomics"
            class="w-full h-36 object-cover rounded-md"
          />
          <div class="mt-2">
            <h3 class="text-sm font-semibold">Frido strives to be a one-stop shop for ergonomic body support</h3>
            <a href="#" class="text-blue-600 font-medium hover:underline mt-1 inline-block text-xs">Read More</a>
          </div>
        </div>
      </div>
...
<section class="py-12 bg-white">
  <div class="container mx-auto px-4">
    ...
    <div class="text-center mb-8">
      ...
      <p class="text-gray-600 mt-2">Read some of the best blogs on ergonomics, comfort & pain management of the human body</p>
    </div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
      ...
      <div class="bg-white rounded-lg shadow-lg overflow-hidden">
        <img 
          src="{{asset('assets/image/download.jpeg')}}" 
          alt="Understanding Flat Feet" 
          class="w-full h-48 object-cover"
        />
        <div class="p-4">
          <h3 class="text-lg font-semibold text-gray-800">Understanding flat feet & symptoms</h3>
          <a href="#" class="text-blue-600 font-medium hover:underline mt-2 inline-block">Read full article</a>
        </div>
      </div>
